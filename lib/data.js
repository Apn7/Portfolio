...
export const experience = [
  {
    ...
    company: "TechnoPLUS IT - Remote (Aus)",
    points: [
      "Built and maintained a Learning Management System (Laravel REST API with a Vue.js admin frontend) using a modular architecture and design patterns (Repository, Service, Observer).",
      "Independently built interactive lesson content support from scratch, including learner result tracking, and designed RESTful APIs with role-based access control (Admin, Teacher, Student).",
      "Designed database tables for lessons that combine pages, quizzes, files and assignments in a custom order, with soft deletes so removed records are not lost.",
    ],
  },
];
